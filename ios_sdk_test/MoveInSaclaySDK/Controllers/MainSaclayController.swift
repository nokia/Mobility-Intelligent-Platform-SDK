...
class MainSaclayController: UITableViewController, MKMapViewDelegate, MGLMapViewDelegate, CLLocationManagerDelegate, UISearchBarDelegate {
    ...
    @IBOutlet weak var nudgeMap: MapSaclay!
