        ...
        AWSMobileClient.sharedInstance().initialize { (userState, error) in
            if let userState = userState {
                ...
                case .signedOut:
                    ...
                    let config = SignInUIOptions(canCancel: false, logoImage: UIImage(named: "lg_mis", in: MoveInSaclaySDK.resourcesBundle, compatibleWith: nil), backgroundColor: UIColor(red:0.03, green:0.13, blue:0.37, alpha:1.0))
