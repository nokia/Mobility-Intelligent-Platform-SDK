...
public class SVCMotion {
    public String [] labels = {"airplane", "automotive", "car", "cycling", "motorcycle",
            "running", "train/bus", "walking"};
    public double [] scalerMean = { 1.03995013, 48.72606943,  2.13934952, 27.5073185 };
    public double [] scalerScale = { 1.42019177,  0.38965926,  0.52780606, 34.2053055 };
    ...
    public SVCMotion(String file) throws FileNotFoundException {
        this.clf = new Gson().fromJson(file, Classifier.class);
    ...
    public static void main(String[] args) throws FileNotFoundException {
        if (args.length > 0 && args[0].endsWith(".json")) {
            ...
            // Estimators:
            SVCMotion clf2 = new SVCMotion(modelData);

            // Prediction:
            int prediction = clf2.predict(features);
            if(prediction <= 7)
                System.out.println(clf2.labels[prediction]);
